...
function getControllerMethodMetadata(constructor) {
    ...
    var genericMetadata = Reflect.getOwnMetadata(constants_1.METADATA_KEY.controllerMethod, Reflect.getPrototypeOf(constructor));
...
function getControllerParameterMetadata(constructor) {
    ...
    var genericMetadata = Reflect.getOwnMetadata(constants_1.METADATA_KEY.controllerParameter, Reflect.getPrototypeOf(constructor));
